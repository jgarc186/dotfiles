...
local expected = {
    ...
    -- Every modifier needs its own "+" ("Ctrl SHIFT + 4" -> "Unknown keysym:
    -- Ctrl SHIFT, did you forget a +?"), AND modifier names are case-sensitive
    -- ("Ctrl + SHIFT + 4" -> "Unknown keysym: Ctrl" since only "CTRL" matches).
